...
import { allJob } from "../../actions/job";
import {
  withRouter,
  Link,
  Switch,
        ...
        <div className="h-screen w-full flex flex-wrap flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
          ...
          <div className="w-9/12">
            <div className="p-3 text-gray-500 ">
              <Switch>
                <Route path="/profile" className="">
                  <Profile />
                </Route>
                <Route path="/post-job" className="">
                  <PostJob />
                </Route>
                <Route path="/get-job" className="">
                  <GetAllJobs />
                </Route>
                <Route path="/job/:id" className="">
                  <Job />
                </Route>
                <Route path="/show-candidate" className="">
                  <ShowCandidate />
                </Route>
